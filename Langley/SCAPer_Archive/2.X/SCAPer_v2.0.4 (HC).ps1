...
"@.split("`n") | Foreach {$_.trim()}
            ...
            "SV-52218r2_rule" { 
                #Can't be checked
                $ActualStatus = "Open"
                $checklist.CHECKLIST.stigs.iSTIG.vuln[$STIG_index].COMMENTS = "MFR/ We have services documented"
                }
                #V-7002
            #Windows Server 2012/2012 R2 Domain Controller Security Technical Implementation Guide :: Version 2, Release: 18 Benchmark Date: 25 Oct 2019
            #The Windows 2012 DNS Server must be configured to enforce authorized access to the corresponding private key.
            "SV-52940r3_rule" { 
                #Can't be checked
                $ActualStatus = "NotAFinding"
                $checklist.CHECKLIST.stigs.iSTIG.vuln[$STIG_index].COMMENTS = "No accounts were returned"
                }
                 #V-36451
            #Windows Server 2012/2012 R2 Domain Controller Security Technical Implementation Guide :: Version 2, Release: 18 Benchmark Date: 25 Oct 2019
            #The Windows 2012 DNS Server must be configured to enforce authorized access to the corresponding private key.
            ...
            "SV-59337r8_rule" { 
                #Can't be checked
                $ActualStatus = "NotAFinding"
                $checklist.CHECKLIST.stigs.iSTIG.vuln[$STIG_index].COMMENTS = "GPO"
                }
                #V-57641
            #Windows Server 2012/2012 R2 Domain Controller Security Technical Implementation Guide :: Version 2, Release: 18 Benchmark Date: 25 Oct 2019
            #The Windows 2012 DNS Server must be configured to enforce authorized access to the corresponding private key.
            ...
            "SV-40977r3_rule" { 
                #Can't be checked
                $ActualStatus = "Open"
                $checklist.CHECKLIST.stigs.iSTIG.vuln[$STIG_index].COMMENTS = "REQ000000382928/Setting needs to be configured in HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\.NETFramework where the AllowStrongNameBypass value does not exist  "
                }
                #V-30937
            #Microsoft DotNet Framework 4.0 STIG :: Version 1, Release: 9 Benchmark Date: 25 Oct 2019
            #The Windows 2012 DNS Server must be configured to enforce authorized access to the corresponding private key.
