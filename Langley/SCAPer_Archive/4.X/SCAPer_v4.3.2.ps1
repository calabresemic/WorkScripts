...
if ($SCAP -eq $true) {
    ...
    Write-Progress -Activity "Scanning the drives for the OS & .NET STIGS" -Status "Scanning the following drives: $scanningdrives" -PercentComplete $percent
    $runningjobs = (Get-Job -State Running).Count
    }

    Write-Progress -Activity "Scanning the drives for the OS & .NET STIGS" -Status "Ready" -Completed
...
"@.Split("`n") | foreach {$_.trim()}
            ...
            "SV-51569r1_rule" { 
                ...
                $defaultacl="O:LSG:LSD:AI(A;ID;FA;;;SY)(A;ID;FA;;;BA)(A;ID;FA;;;S-1-5-80-880578595-1860270145-482643319-2788375705-1540778122)"
