...
#Set Home Page
Set-RegistryValue -Path "HKCU:\Software\Microsoft\Internet Explorer\Main" -Name "Start Page" -Value "https://eim2.amc.af.mil/org/436msg/BaseBulletin/default.aspx" -PropertyType String
...
#*****436 MOS Squadron Drives*****
If("436MOS Users" -in $groups)
{
Map-NetworkDrive S "\\fjxt-fs-001v\436 MOS\FJXT-436 MOS-G"
}

If("436MXG Users" -in $groups)
{
Map-NetworkDrive L "\\fjxt-fs-001v\MXG_Public_Share\FJXT-MXG_Public_Share-G"
}

If("LssManpower" -in $groups)
{
Map-NetworkDrive N "\\FJXTMXGIETM\lg$"
}

If("LgExecutiveSupport" -in $groups)
{
Map-NetworkDrive N "\\FJXTMXGIETM\lg$"
}
...
If("LgExecutiveSupport" -in $groups)
{
Map-NetworkDrive S "\\fjxt-fs-001v\436 MXG\FJXT-436 MXG-G"
}
