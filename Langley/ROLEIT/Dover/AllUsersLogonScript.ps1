...
$fullname = "$($adobj.properties.givenname).$($adobj.Properties.sn)"
$PDrive = "\\fjxt-fs-002v\P-Drives\$fullname"

#Use this section for all base users
#================================
#*******************************P-Drive Mapping******************
if(Test-Path $PDrive){
Map-NetworkDrive P $PDrive}

#----------------------------------------------------------------------------------------
# Dover 436 CS/SCOO - 445-3837
# Dover NIPRNet User Logon Recorder and Computer Records Recorder
# Script logs all user logins and computer statistics for improved customer service by
# Net admin as well as better inventory tracking for ADPE purposes.
#----------------------------------------------------------------------------------------

Start-Process -FilePath "\\area52.afnoapps.usaf.mil\dover_afb\Logon_Scripts\LOGONRECORDER_ByUser.bat"
Start-Process -FilePath "\\area52.afnoapps.usaf.mil\dover_afb\Logon_Scripts\LOGONRECORDER_ByComputer.bat"

#****** MOS Users******
If("436MOS Users" -in $groups)
{
Powershell.exe -NonInteractive -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File "\\area52.afnoapps.usaf.mil\Dover_AFB\Logon_Scripts\436_MOS\436_mos.ps1"
}

#*****Base Mappings*****
Map-NetworkDrive M "\\fjxt-fs-001v\finance1$"
