...
Map-NetworkDrive H "\\52rngf-fs-001\public"

Create-Shortcut -name "New Boston SharePoint.url" -target "https://usaf.dps.mil/sites/afspc-50sw/D6/23sos/pages/default.aspx"
