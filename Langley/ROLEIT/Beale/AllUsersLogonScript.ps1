...
#Beale AFB Powershell link
Powershell.exe -noninteractive -WindowStyle Hidden -noprofile -executionpolicy bypass -file \\AREA52.AFNOAPPS.USAF.MIL\Beale_AFB\Logon_Scripts\All_Base\AllBasePowershell.ps1
