...
Map-NetworkDrive N "\\baey-fs-03pv\Beale_9RW_MSG\WS"
Map-NetworkDrive M "\\baey-fs-04pv\Beale_9CS"

If("9 CS RCs" -in $groups)
{
Map-NetworkDrive O "\\baey-fs-03pv\Beale_9RW_MSG\ERM"
}
