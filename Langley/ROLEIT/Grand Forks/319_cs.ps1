...
Map-NetworkDrive P "\\jfsl-qs-001v\printers"
Map-NetworkDrive G "\\jfsl-fs-01pv\GrandForks_319_MSG\319-CS"
Map-NetworkDrive S "\\jfsl-fs-01pv\GrandForks_319_RW_S"

if("jfsd-fp-offrec" -in $groups)
{
Map-NetworkDrive O "\\jfsl-fs-02pv\GrandForks_ACC_OFF_REC\ERM Server"
}

if("GLS_319 CS_SCOI-MCS" -in $groups)
{
Map-NetworkDrive G "\\jfsl-fs-01pv\319-MSG-G\319-CS\SCO\SCOI\Telecomm"
}
