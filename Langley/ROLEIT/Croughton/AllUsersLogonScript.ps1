...
#================================
If("CRO Users" -in $groups)
{
Map-NetworkDrive S "\\EXSS-FS-001V\cro-sdr1$"
Map-NetworkDrive R "\\EXSS-FS-001V\cro-rdr1$"
Map-NetworkDrive O "\\EXSS-FS-001V\cro-odr1$"
Map-NetworkDrive M "\\EXSS-FS-001V\CRO_MDR\Official Multimedia"
Map-NetworkDrive F "\\gkux-fs-001v\frd-sdr1$\"
}

If("422ABG_COMMANDERS" -in $groups)
{
Create-Shortcut "Commander-Playbook.lnk" "https://portal.usafe.af.mil/sites/501CSW/Documents/Commander's%20Playbook/501st%20Commander's%20Playbook%20Working%204.pdf" "C:\Windows\System32\url.dll"
}
If("422ABG_CCF" -in $groups)
{
Create-Shortcut "Commander-Playbook.lnk" "https://portal.usafe.af.mil/sites/501CSW/Documents/Commander's%20Playbook/501st%20Commander's%20Playbook%20Working%204.pdf" "C:\Windows\System32\url.dll"
}
If("UDG_422 ABG_SQ SUPERINTENDENTS" -in $groups)
{
Create-Shortcut "Commander-Playbook.lnk" "https://portal.usafe.af.mil/sites/501CSW/Documents/Commander's%20Playbook/501st%20Commander's%20Playbook%20Working%204.pdf" "C:\Windows\System32\url.dll"
}
