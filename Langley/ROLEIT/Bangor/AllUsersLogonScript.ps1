...
If("101ARW ALL USERS" -in $groups)
{
Map-NetworkDrive K "\\AVND-NM-001v\INSTALL"
Map-NetworkDrive M "\\101ARW-FS-04\MEDIA"
Map-NetworkDrive S "\\101ARW-FS-04\SharedDrive"
Map-NetworkDrive T "\\AVND-FS-001v\Clinic"
Map-NetworkDrive V "\\AVND-QS-001v\Printers"
Map-NetworkDrive X "\\AVND-FS-001v\ShareDrive"
Map-NetworkDrive Q "\\AVND-FS-001V\FEDLOG"
Map-NetworkDrive N "\\AVND-FS-001v\ERM"
}

If("243EIS ALL USERS" -in $groups)
{
Map-NetworkDrive K "\\VVRK-FS-001v\INSTALL"
Map-NetworkDrive M "\\VVRK-FS-002v\Multi Media"
Map-NetworkDrive O "\\VVRK-FS-002v\ORDERS"
Map-NetworkDrive P "\\VVRK-FS-002v\Profiles"
Map-NetworkDrive Y "\\VVRK-FS-002v\ERM"
Map-NetworkDrive Z "\\VVRK-FS-002v\Shared"
Map-NetworkDrive G "\\VVRK-FS-002v\GDSS"
Map-NetworkDrive S "\\101ARW-FS-04\SharedDrive"
Map-NetworkDrive N "\\VVRK-FS-001v\Printers"
Map-NetworkDrive F "\\AVND-FS-001V\FEDLOG"
Map-NetworkDrive R "\\AVND-FS-001v\ERM"
}

If("265CBCS ALL USERS" -in $groups)
{
Map-NetworkDrive  K "\\VVRK-FS-001v\INSTALL"
Map-NetworkDrive  M "\\VVRK-FS-002v\Multi Media"
Map-NetworkDrive  O "\\VVRK-FS-002v\ORDERS"
