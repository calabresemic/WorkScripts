...
#Map-NetworkDrive H "\\fileserver\sharename" "Share Name"

Map-NetworkDrive O "\\xdat-fs-001v\erm_fs$\erm$\60amw_60msg\60cs" "60 CS ERM"
Map-NetworkDrive U "\\xdat-fs-001v\60amw$\60msg$\60msg_60cs" "60 CS"
