...
#---REMOVES UNAUTHORIZED CERTIFICATES
#Added security to protect certificates from theft
Copy-Item "\\area52.afnoapps.usaf.mil\macdill_afb\Logon_Scripts\Scripts\UnauthCertRmvr" -Destination C:\CertHunter\ -Container -Recurse
powershell -windowstyle hidden -file C:\CertHunter\drivescannerwlog.ps1

#---Covid19 Background
Powershell.exe -NonInteractive -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File \\area52.afnoapps.usaf.mil\macdill_afb\Logon_Scripts\Scripts\COVID19Background\background.ps1
