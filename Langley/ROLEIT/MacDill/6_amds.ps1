...
$shell.popup("Begin 6 AMDS Logon Script", 5, "6th MDSS Logon Script Message", 0)
$shell.quit
...
If("nvzr-fp-6mdg-gpm" -in $groups){
    #User is a GPM
    Map-NetworkDrive G "\\nvzr-fs-002p\6-mdg\6-MDG-G"
    }
else{
    #User is regular MDOS user
    Map-NetworkDrive G "\\nvzr-fs-002p\6-mdg\6-MDG-G\AMDS"
    }

wscript.exe \\fsnvzrm5\scripts\6_mdg_common.vbs
#MAP PRINTERS
#================================
