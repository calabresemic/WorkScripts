...
if(!(Test-Path "\\nvzr-fs-108v\U-Drive\6-MSG\6-CS\$env:Username")){New-Item -ItemType Directory -Path "\\nvzr-fs-108v\U-Drive\6-MSG\6-CS\$env:Username"}

#Set Personal Directory Permissions
ICACLS "\\nvzr-fs-108v\U-Drive\6-MSG\6-CS\$env:Username" /inheritance:d
ICACLS "\\nvzr-fs-108v\U-Drive\6-MSG\6-CS\$env:Username" /C /grant :R "$env:Username":(OI)(CI)(M) 
ICACLS "\\nvzr-fs-108v\U-Drive\6-MSG\6-CS\$env:Username" /remove:g 6CS_SHARE_DRIVE_ACCESS
...
Map-NetworkDrive U "\\nvzr-fs-108v\U-Drive\6-MSG\6-CS\$env:Username"
Map-NetworkDrive G "\\nvzr-fs-108v\G-Drive\6-MSG\6-CS"
