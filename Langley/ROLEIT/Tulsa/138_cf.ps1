...
Map-NetworkDrive S "\\XHZG-FS-01P\138CF"

If("138 FW 138CCB" -in $groups)
{
Map-NetworkDrive J "\\XHZG-FS-01P\CCB"
}

If("138 FW 138IA" -in $groups)
{
Map-NetworkDrive Y "\\XHZG-NM-001v\SCXS"
}

If("138 FW NCC Users" -in $groups)
{
Map-NetworkDrive H "\\ANG-SS-01\shared"
Map-NetworkDrive N "\\XHZG-NM-001v\SCO"
Map-NetworkDrive Z "\\XHZG-FS-01P\CSA"
}

If("138 CF NCC Administrators" -in $groups)
{
Map-NetworkDrive H "\\ANG-SS-01\shared"
Map-NetworkDrive N "\\XHZG-NM-001v\SCO"
Map-NetworkDrive Z "\\XHZG-FS-01P\CSA"
...
If("138 FW SCXP-Users" -in $groups)
{
Map-NetworkDrive Q "\\XHZG-NM-001v\SCXP"
}
