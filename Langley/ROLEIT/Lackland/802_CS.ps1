...
Map-NetworkDrive P "\\MPLS-FS-102p\802CS\802CS_Common"
Map-NetworkDrive O "\\MPLS-FS-102p\802CS\802CS_ORG"
Map-NetworkDrive R "\\MPLS-FS-102p\Lackland_ERM"
Map-NetworkDrive S "\\MPLS-FS-102p\Public"
