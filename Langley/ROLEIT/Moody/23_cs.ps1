...
Map-NetworkDrive U "\\52qseu-fs-05pv\Moody_MSG\CS"
...
If("23 CS CFP" -in $groups)
{
Map-NetworkDrive L "\\52qseu-fs-05pv\Moody_MSG\cs\sco"
}

If("CS-SCM ALL" -in $groups)
{
Map-NetworkDrive Q "\\52qseu-fs-05pv\Moody_MSG\cs\scq"
}

If("CS-SCO" -in $groups)
{
Map-NetworkDrive O "\\52qseu-fs-05pv\Moody_MSG\CS\sco"
}

If("CS-SCOI" -in $groups)
{
Map-NetworkDrive Q "\\52qseu-fs-05pv\Moody_MSG\sco\scoi"
}

If("CS-PLANS FLT Staff" -in $groups)
{
Map-NetworkDrive M "\\52qseu-fs-05pv\Moody_MSG\plnimpflt$"
Map-NetworkDrive W "\\52qseu-fs-05pv\Moody_MSG\phones$"
Map-NetworkDrive Z "\\52qseu-fs-05pv\Moody_MSG\lmr$"
}

If("CS-METAV" -in $groups)
{
Map-NetworkDrive O "\\52qseu-fs-05pv\Moody_MSG\atcals$"
}

If("CS-Support" -in $groups)
{
Map-NetworkDrive O "\\52qseu-fs-05pv\Moody_MSG\cs\scx"
Map-NetworkDrive R "\\52qseu-fs-05pv\Moody_MSG\VI$"
}

If("cs-radio" -in $groups)
{
Map-NetworkDrive G "\\52qseu-fs-05pv\Moody_MSG\radio$"
}

If("CS-LMR" -in $groups)
{
Map-NetworkDrive H "\\52qseu-fs-05pv\Moody_MSG\lmr$"
}

If("CS-qa" -in $groups)
{
Map-NetworkDrive I "\\52qseu-fs-05pv\Moody_MSG\qa$"
}

If("CS-telephones" -in $groups)
{
Map-NetworkDrive J "\\52qseu-fs-05pv\Moody_MSG\phones$"
}

If("CS-switchboard" -in $groups)
{
Map-NetworkDrive K "\\52qseu-fs-05pv\Moody_MSG\switchbrd$"
}