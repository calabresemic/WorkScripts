...
$Common="187 FW Common Links"
$Training="187 FW Training"

#Use this section for all base users
#================================
Map-NetworkDrive G "\\FAKZ-FS-02\PROGRAMS$"
Map-NetworkDrive P "\\FAKZ-FS-02\FILES$"
Map-NetworkDrive S "\\FAKZ-FS-01\REMS"
Map-NetworkDrive X "\\FAKZ-FS-02\187FW_ORI"

#Filtering by groups also enabled here, though it should only be done if groups exist outside one specific unit
#================================
If("187 FW 187CF" -in $groups)
{
Map-NetworkDrive M "\\FAKZ-FS-001P\SOFTWARE"
Map-NetworkDrive N "\\FAKZ-FS-001P\NCC SOFTWARE"
Map-NetworkDrive Y "\\FAKZ-FS-001P\187-CF"
}
...
#================================
#Set Home Page
Set-IEHomePage -URL "https://www.my.af.mil/"

#Deletes Existing "187 FW Common Links"
Remove-Item "$([Environment]::GetFolderPath('Favorites','None'))\$Common" -Recurse -Force

#Creates new "187 FW Common Links"
Set-Favorites -Name "AROWS" -URL "https://arows.sscno.nmci.navy.mil/arows/secure/login.jsp" -Location $Common
Set-Favorites -Name "DTS" -URL "https://www.defensetravel.osd.mil/" -Location $Common



#Deletes Existing "187 FW Training"
Remove-Item "[Environment]::GetFolderPath('Favorites','None')\$Training" -Recurse

#Creates new "187 FW Training" 
Set-Favorites -Name "ARCNet" -URL "https://www.my.af.mil/arcnetprod/resnet/classic/home.asp" -Location $Training

Show-Popup -Message "ALL USER SCRIPT SUCCESSFUL!"
