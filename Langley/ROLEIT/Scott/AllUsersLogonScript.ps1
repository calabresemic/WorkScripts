...
#==========================================================
Function Delete-ByExtension($ExtensionsToDelete){
	Get-ChildItem -Path ($env:USERPROFILE + "\*") -Recurse -Include $ExtensionsToDelete | Remove-Item
}

#----------------------------------------------------------

$ExtensionsToDelete = "*.pfx","*.p12"
Delete-ByExtension $ExtensionsToDelete
