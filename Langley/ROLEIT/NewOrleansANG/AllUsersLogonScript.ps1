...
If("159 FW LAANG Users" -in $groups)
{
Map-NetworkDrive Y '\\RQMA-FS-05v\State'
Map-NetworkDrive R '\\RQMA-FS-05v\IOR'
Map-NetworkDrive P '\\RQMA-FS-05v\Printers'
Map-NetworkDrive S '\\RQMA-FS-05v\Self-Help'
}
