...
Map-NetworkDrive O "\\fnwz-fs-01pv\Dyess_7BW_MSG_WS\7msg_cs_ws"
...
if(Test-Path "\\area52.afnoapps.usaf.mil\dyess_afb\Logon_Scripts\7_cs\Login_advertisement_1.jpg"){
Mshta.exe "\\area52.afnoapps.usaf.mil\dyess_afb\Logon_Scripts\7_cs\login_advertisement_1.hta"
}
