...
Map-NetworkDrive S "\\DBHN-FS-003P\Sections"
Map-NetworkDrive T "\\DBHN-FS-002P\Fedlog"

#Filtering by groups also enabled here, though it should only be done if groups exist outside one specific unit
#================================
If("cc_visitors" -in $groups)
{
Map-NetworkDrive V "\\DBHN-FS-003P\SECTIONS\WORKCENTERS\GUESTS"
}
